...
public class herenciaSimple {
	public static void main(String args[]){
        ...
        PersonaEscuela pe1 = new PersonaEscuela();
        PersonaTrabajo pt1 = new PersonaTrabajo();
        PersonaCasa pc1 = new PersonaCasa();
        ...
        pc1.setRol("hija");
        pc1.setEcoActivo("si");
        pe1.setMatricula(123435);
        pe1.setPromedio(80.5);
        pt1.setNumEmp(15500);
        pt1.setSueldo(5000);
        ...
        System.out.println("Rol: " + pc1.getRol());
        System.out.println("Economicamente Activo: " + pc1.getEcoActivo());
        System.out.println("Matricula: " + pe1.getMatricula());
        System.out.println("Promedio: " + pe1.getPromedio());
        System.out.println("Numero de empleado: " + pt1.getNumEmp());
        System.out.println("Sueldo: " + pt1.getSueldo());
    }
